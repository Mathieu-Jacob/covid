...
#Filter on select regions
selected.states <- c("New York", "New Jersey", "Pennsylvania", "Connecticut", "South Carolina", "Massachusetts", "Florida", "Maine", "California")
cases <- cases %>% filter(region %in% selected.states)
